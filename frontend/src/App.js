import './App.css';
//importing necessary components and functions from the react router dom and this components is used for client side routing in react applications
...
function App() {
  const stripePromise=loadStripe("pk_test_51P1u0QSCiSbEirgVDIrcR56uVZPt3OFWTSIIpUeP7Br47x5iRZpMRJhrAJeHPqEP8rdW7OCnSBPjPBpREnWUBGD4008GngVlhC")
  ...
  //managing routing config for the  application 
  const router=createBrowserRouter(
    //create routes from the elements passed to it
    createRoutesFromElements(
      //define the route components that matches all paths "/"and renders the main components 
  ...
  return (
    <div className="App">
      {/* This ensures that the routing functionality is available throughtout the application */}
